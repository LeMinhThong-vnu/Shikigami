...
TARGET_OBJECTS = src/objects/game_object.cpp src/objects/baby.cpp src/objects/enemy.cpp src/objects/ghost.cpp src/objects/shikigami.cpp src/objects/fox.cpp src/objects/player.cpp src/objects/ui.cpp
TARGET = src/main.cpp
